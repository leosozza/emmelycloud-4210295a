      ...
      const robots = [
        ...
        },
        {
          ...
          PROPERTIES: {
            ...
            value: { Name: "Valor", Type: "double", Description: "Valor manual (senão usa produtos/template/serviço/OPPORTUNITY)" },
            ...
            send_method: { Name: "Método de Envio", Type: "select", Options: { none: "Não enviar", link: "Enviar Link", pdf: "Enviar PDF", both: "Link + PDF" }, Default: "none", Description: "Enviar resultado ao cliente via WhatsApp" },
            send_to_phone: { Name: "Telefone para Envio", Type: "string", Description: "Número WhatsApp para enviar o orçamento (com código do país)" },
          },
          RETURN_PROPERTIES: {
