  ...
  if (reqUrl.searchParams.get("action") === "repair_fields") {
    ...
    try {
      ...
      const emmelyUserFields = [
        ...
        { FIELD_NAME: "UF_CRM_EMMELY_TOTAL_AMOUNT", USER_TYPE_ID: "money", SORT: 0,
          EDIT_FORM_LABEL: { br: "VALOR TOTAL DA COBRANÇA", en: "TOTAL AMOUNT" },
          LIST_COLUMN_LABEL: { br: "VALOR TOTAL", en: "TOTAL AMOUNT" },
          LIST_FILTER_LABEL: { br: "VALOR TOTAL", en: "TOTAL AMOUNT" },
          SETTINGS: { SIZE: 20, PRECISION: 2 } },
        { FIELD_NAME: "UF_CRM_EMMELY_DOWN_PAYMENT", USER_TYPE_ID: "money", SORT: 0,
          EDIT_FORM_LABEL: { br: "VALOR DE ENTRADA", en: "DOWN PAYMENT" },
          LIST_COLUMN_LABEL: { br: "VALOR ENTRADA", en: "DOWN PAYMENT" },
          LIST_FILTER_LABEL: { br: "VALOR ENTRADA", en: "DOWN PAYMENT" },
          SETTINGS: { SIZE: 20, PRECISION: 2 } },
        { FIELD_NAME: "UF_CRM_EMMELY_DOWN_INSTALLMENTS", USER_TYPE_ID: "integer", SORT: 0,
          EDIT_FORM_LABEL: { br: "Nº PARCELAS DA ENTRADA", en: "DOWN INSTALLMENTS" },
          LIST_COLUMN_LABEL: { br: "Nº PARC. ENTRADA", en: "DOWN INSTALLMENTS" },
          LIST_FILTER_LABEL: { br: "Nº PARC. ENTRADA", en: "DOWN INSTALLMENTS" } },
        { FIELD_NAME: "UF_CRM_EMMELY_DOWN_METHOD", USER_TYPE_ID: "string", SORT: 0,
          EDIT_FORM_LABEL: { br: "MÉTODO DA ENTRADA", en: "DOWN METHOD" },
          LIST_COLUMN_LABEL: { br: "MÉTODO ENTRADA", en: "DOWN METHOD" },
          LIST_FILTER_LABEL: { br: "MÉTODO ENTRADA", en: "DOWN METHOD" } },
        { FIELD_NAME: "UF_CRM_EMMELY_DOWN_FIRST_DUE", USER_TYPE_ID: "date", SORT: 0,
          EDIT_FORM_LABEL: { br: "1º VENCIMENTO DA ENTRADA", en: "DOWN FIRST DUE" },
          LIST_COLUMN_LABEL: { br: "1º VENC. ENTRADA", en: "DOWN FIRST DUE" },
          LIST_FILTER_LABEL: { br: "1º VENC. ENTRADA", en: "DOWN FIRST DUE" } },
        { FIELD_NAME: "UF_CRM_EMMELY_DOWN_INTERVAL", USER_TYPE_ID: "integer", SORT: 0,
          EDIT_FORM_LABEL: { br: "INTERVALO DA ENTRADA (DIAS)", en: "DOWN INTERVAL (DAYS)" },
          LIST_COLUMN_LABEL: { br: "INTERVALO ENTRADA", en: "DOWN INTERVAL" },
          LIST_FILTER_LABEL: { br: "INTERVALO ENTRADA", en: "DOWN INTERVAL" } },
        { FIELD_NAME: "UF_CRM_EMMELY_REMAINING_BALANCE", USER_TYPE_ID: "money", SORT: 0,
          EDIT_FORM_LABEL: { br: "SALDO A PARCELAR", en: "REMAINING BALANCE" },
          LIST_COLUMN_LABEL: { br: "SALDO A PARCELAR", en: "REMAINING BALANCE" },
          LIST_FILTER_LABEL: { br: "SALDO A PARCELAR", en: "REMAINING BALANCE" },
          SETTINGS: { SIZE: 20, PRECISION: 2 } },
        { FIELD_NAME: "UF_CRM_EMMELY_FIRST_DUE_DATE", USER_TYPE_ID: "date", SORT: 0,
          EDIT_FORM_LABEL: { br: "1º VENCIMENTO DAS PARCELAS", en: "FIRST DUE DATE" },
          LIST_COLUMN_LABEL: { br: "1º VENCIMENTO", en: "FIRST DUE" },
          LIST_FILTER_LABEL: { br: "1º VENCIMENTO", en: "FIRST DUE" } },
        { FIELD_NAME: "UF_CRM_EMMELY_INSTALLMENT_INTERVAL", USER_TYPE_ID: "integer", SORT: 0,
          EDIT_FORM_LABEL: { br: "INTERVALO ENTRE PARCELAS (DIAS)", en: "INSTALLMENT INTERVAL (DAYS)" },
          LIST_COLUMN_LABEL: { br: "INTERVALO PARCELAS", en: "INSTALLMENT INTERVAL" },
      ...
      const stageOptions = await loadDealStageOptions(ep, token);
      ...
      const repairRobots = [
        {
          ...
          PROPERTIES: {
            ...
            message: { Name: "Mensagem / Legenda", Type: "text", Required: "N", Description: "Texto (para 'text') ou legenda de mídia. Deixe vazio se enviar só arquivo/lista." },
            message_type: { Name: "Tipo de Mensagem", Type: "select", Required: "N", Default: "text", Options: { text: "Texto", image: "Imagem", video: "Vídeo", audio: "Áudio", document: "Documento", buttons: "Botões de resposta", link_button: "Link (com preview)", list: "Lista interativa" }, Description: "Para templates HSM, use o robot 'Emmely: Enviar WhatsApp Template'." },
            media_url: { Name: "URL do Arquivo", Type: "string", Required: "N", Description: "URL pública do arquivo (image/video/audio/document)" },
            filename: { Name: "Nome do Arquivo", Type: "string", Required: "N", Description: "Nome do arquivo (só documento). Ex: contrato.pdf" },
            buttons: { Name: "Botões de Resposta", Type: "text", Required: "N", Description: "Até 3 botões separados por ; ou |. Ex: Sim;Não;Talvez  ou  id_sim:Sim;id_nao:Não" },
            link_button_text: { Name: "Texto do Botão Link", Type: "string", Required: "N", Description: "Ignorado (o WhatsApp mostra o URL como preview). Preenchido apenas por referência." },
            link_button_url: { Name: "URL do Botão Link", Type: "string", Required: "N", Description: "URL a incluir na mensagem quando tipo = Link" },
            list_title: { Name: "Título da Lista", Type: "string", Required: "N", Description: "Título mostrado no topo da lista" },
            list_button_text: { Name: "Texto do Botão da Lista", Type: "string", Required: "N", Default: "Selecionar", Description: "Texto do botão que abre a lista" },
            list_items: { Name: "Itens da Lista", Type: "text", Required: "N", Description: "Itens separados por ;  formato id:Título:Descrição. Ex: 1:Consulta:Falar com advogado;2:Preços:Ver tabela" },
          },
          RETURN_PROPERTIES: {
        ...
        },
        {
          ...
          PROPERTIES: {
            phone: { Name: "Telefone", Type: "string", Required: "Y", Description: "Número com código do país. Ex: +351912345678" },
            template_name: { Name: "Nome do Template", Type: "string", Required: "Y", Description: "Nome exato do template aprovado no Meta/Gupshup (ex: linkemmely)" },
            template_language: { Name: "Idioma do Template", Type: "string", Required: "N", Default: "pt_BR", Description: "Código do idioma aprovado. Ex: pt_BR, pt_PT, en_US" },
            template_params: { Name: "Parâmetros ({{1}},{{2}},...)", Type: "text", Required: "N", Description: "Valores separados por | na ordem das variáveis. Ex: João|1234|10€" },
          },
          RETURN_PROPERTIES: {
            message_id: { Name: "ID da Mensagem", Type: "string" },
            status: { Name: "Status", Type: "string" },
      ...
      const robots = [
        {
          ...
          PROPERTIES: {
            phone: { Name: "Telefone", Type: "string", Required: "Y", Description: "Número de telefone com código do país" },
            message: { Name: "Mensagem / Legenda", Type: "text", Required: "N", Description: "Texto (para 'text') ou legenda de mídia. Deixe vazio se enviar só arquivo/template/lista." },
            message_type: { Name: "Tipo de Mensagem", Type: "select", Required: "N", Default: "text", Options: { text: "Texto", image: "Imagem", video: "Vídeo", audio: "Áudio", document: "Documento", template: "Template (HSM)", buttons: "Botões de resposta", link_button: "Link (com preview)", list: "Lista interativa" }, Description: "Escolha o tipo. Botões CTA com URL só existem em templates aprovados." },
            media_url: { Name: "URL do Arquivo", Type: "string", Required: "N", Description: "URL pública do arquivo (image/video/audio/document)" },
            filename: { Name: "Nome do Arquivo", Type: "string", Required: "N", Description: "Nome do arquivo (só documento). Ex: contrato.pdf" },
            template_name: { Name: "Nome do Template", Type: "string", Required: "N", Description: "Nome exato do template aprovado (Meta/Gupshup)" },
            template_language: { Name: "Idioma do Template", Type: "string", Required: "N", Default: "pt_BR", Description: "Ex: pt_BR, pt_PT, en_US" },
            template_params: { Name: "Parâmetros do Template", Type: "text", Required: "N", Description: "Valores separados por | na ordem das variáveis. Ex: João|1234|10€" },
            buttons: { Name: "Botões de Resposta", Type: "text", Required: "N", Description: "Até 3 botões separados por ; ou |. Ex: Sim;Não;Talvez  ou  id_sim:Sim;id_nao:Não" },
            link_button_text: { Name: "Texto do Botão Link", Type: "string", Required: "N", Description: "Ignorado (o WhatsApp mostra o URL como preview). Preenchido apenas por referência." },
            link_button_url: { Name: "URL do Botão Link", Type: "string", Required: "N", Description: "URL a incluir na mensagem quando tipo = Link" },
            list_title: { Name: "Título da Lista", Type: "string", Required: "N", Description: "Título mostrado no topo da lista" },
        ...
        },
        {
          ...
          NAME: "Emmely: Enviar Relatório de Pagamentos",
          DESCRIPTION: {
            br: "Gera um link público com o relatório completo de pagamentos do cliente (parcelas pagas, em aberto e atrasadas) e grava-o no campo 'Link Relatório Pagamento' do negócio.\n\n📋 CONFIGURAÇÃO:\n• deal_id: Use {{ID}} para o negócio actual\n• send_method: 'Apenas gerar' grava só no campo | 'Enviar via WhatsApp' envia o link ao cliente\n• phone: Opcional — se vazio, usa o telefone do contacto da deal\n• custom_message: Texto antes do link (ex: 'Olá, segue o relatório das suas parcelas')\n\n💡 O cliente abre o link e vê todas as parcelas com botão 'Pagar' nas pendentes — gera Stripe Checkout on-demand.",
            en: "Generates a public payment report link with a 'Pay' button per pending installment and stores it in the deal's UF_CRM_EMMELY_RECEIPT_URL field.",
          },
          PROPERTIES: {
            deal_id: { Name: "ID do Negócio", Type: "string", Required: "Y", Default: "{=Document:ID}", Description: "Use {{ID}} para o negócio actual" },
            client_name: { Name: "Nome do Cliente", Type: "string", Description: "Opcional — para cabeçalho do relatório" },
            deal_title: { Name: "Título / Serviço", Type: "string", Description: "Opcional — descrição mostrada no relatório" },
            send_method: { Name: "Método de Envio", Type: "select", Options: { none: "Apenas gerar e gravar URL", link: "Enviar link via WhatsApp", whatsapp_with_button: "WhatsApp com botão" }, Default: "none" },
            phone: { Name: "Telefone (opcional)", Type: "string", Description: "Se vazio, usa o telefone do contacto da deal" },
            custom_message: { Name: "Mensagem Personalizada", Type: "text", Description: "Texto antes do link" },
          },
          RETURN_PROPERTIES: {
            report_url: { Name: "URL do Relatório", Type: "string" },
            send_status: { Name: "Status de Envio", Type: "string" },
