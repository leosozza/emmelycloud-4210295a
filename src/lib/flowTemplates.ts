...
export const FLOW_TEMPLATES: FlowTemplate[] = [
  ...
  // ─── TEMPLATE: EMMELY FERNANDES ADVOCACIA ───────────────────────────────────
  {
    ...
    nodes: [
      ...
      { id: "ai_ret",     type: "custom", position: { x: 900,  y: 340 }, data: { nodeType: "ai_response",  label: "Analisar Retorno (Whisper)",   prompt: "Você é assistente jurídico do Escritório Emmely Fernandes. Analise a mensagem do cliente que está retornando. Gere: #Resumo, #Tipo de solicitação, #Sugestão. NÃO envie mensagens ao cliente.", config: { sendAsWhisper: true } } },
