...
const ExpandableChat: React.FC<ExpandableChatProps> = ({
  ...
  return (
    <div className={cn("fixed z-50", chatConfig.positions[position], className)} {...props}>
      <div
        ref={chatRef}
        className={cn(
          "flex flex-col bg-background border border-border shadow-lg rounded-2xl overflow-hidden transition-all duration-250 ease-out origin-bottom",
