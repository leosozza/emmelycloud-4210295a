...
const phases: RoadmapPhase[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { name: "Funil Kanban", description: "Drag & drop leads por estágio", progress: 0, status: "por_iniciar" },
      { name: "Formulário de Leads", description: "Cadastro completo de leads", progress: 0, status: "por_iniciar" },
      { name: "Ficha do Lead", description: "Visualização detalhada do lead", progress: 0, status: "por_iniciar" },
      { name: "Triagem com IA", description: "Classificação automática + score", progress: 0, status: "por_iniciar" },
      { name: "Casos Jurídicos", description: "CRUD de casos com fichas", progress: 0, status: "por_iniciar" },
      { name: "Propostas", description: "Criação, envio e status", progress: 0, status: "por_iniciar" },
      { name: "Contratos", description: "Upload e assinatura", progress: 0, status: "por_iniciar" },
    ],
  },
  {
  ...
  },
  {
    ...
    modules: [
      ...
      { name: "Integração Bitrix24", description: "Sincronização bidirecional", progress: 0, status: "por_iniciar" },
      { name: "WhatsApp Cloud API", description: "Mensagens via API oficial", progress: 0, status: "por_iniciar" },
      { name: "Instagram DM", description: "Integração com mensagens diretas", progress: 0, status: "por_iniciar" },
